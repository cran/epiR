---
title: "epiR - RSurveillance function mapping"
author: "Evan Sergeant and Mark Stevenson"
date: "`r Sys.Date()`"
link-citations: yes
output:
  knitr:::html_vignette:
...
vignette: >
  ...
  %\VignetteIndexEntry{epiR-RSurveillance function mapping}
...
```{r sepcen.tab, echo=FALSE, message=FALSE, warnings=FALSE, results='asis'}
...
```{r seppas.tab, echo=FALSE, message=FALSE, warnings=FALSE, results='asis'}
...
```{r misc.tab, echo=FALSE, message=FALSE, warnings=FALSE, results='asis'}
