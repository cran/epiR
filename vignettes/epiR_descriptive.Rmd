...
```
Now create a ranked error bar plot. Because its useful to provide the region-area names on the horizontal axis rotate the horizontal axis labels by 90 degrees.
...
```
There are two ways to fix this problem. First, we can ask R to switch the order of the rows and columns:
