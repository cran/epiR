...
print.epi.2by2 <- function(x, ...) {
  ...
  if(x$method == "cohort.count" & x$n.strata == 1){
    ...
    with(x$res, {
      ...
      .PAFRisk <- format(paste(round(PAFRisk.strata.wald[1] * 100, digits = 2)), width = 20, justify = "right")
  ...
  if(x$method == "cohort.count" & x$n.strata > 1){
    ...
    cat(sprintf("%-34s %-20s %-7s %-7s", "\nTest combined OR = 1:", "Test statistic", "df", "Pr>chi2"))
    cat(sprintf("%-34s %-20s %-7s %-7s", "\n", mhts, mhdf, mhp))
    cat("\n")    
  ...
  if(x$method == "cohort.time" & x$n.strata == 1){
    ...
    with(x$res, {
      ...
      .PAFRate <- format(paste(round(PAFRate.crude.wald[1] * 100, digits = 2), sep = ""), width = 20, justify = "right")
  ...
  if(x$method == "cohort.time" & x$n.strata > 1){
    ...
    cat(sprintf("%-34s %-20s %-7s %-7s", "\nTest OR = 1:", "Test statistic", "df", "Pr>chi2"))
    cat(sprintf("%-34s %-20s %-7s %-7s", "\n", mhts, mhdf, mhp))
    cat("\n")    
  ...
  if(x$method == "cross.sectional" & x$n.strata == 1){
    ...
    with(x$res, {
      ...
      .PAFRisk <- format(paste(round(PAFRisk.strata.wald[1], digits = 2), sep = ""), width = 20, justify = "right")
