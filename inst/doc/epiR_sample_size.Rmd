...
The EpiTools app for [iPhone](https://apps.apple.com/vn/app/epi-tools/id1611139482) and [Android](https://play.google.com/store/apps/details?id=au.melbourne.uni.epitools) devices provides easy access to many of the sample size functions in `epiR` using a smart phone.
...
```
A total of 17 villages need to be sampled to meet the requirements of this study. From each sampled village 20 individuals are sampled which means that at total of 17 $\times$ 20 = 340 individuals are required. Function `epi.ssclus2estb` returns a warning message that the number of clusters is less than 25.
